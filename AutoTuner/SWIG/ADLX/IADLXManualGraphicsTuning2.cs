...
public class IADLXManualGraphicsTuning2 : IADLXInterface {
  ...
  public virtual ADLX_RESULT GetGPUMinFrequency(out int minFreq) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualGraphicsTuning2_GetGPUMinFrequency(swigCPtr, out minFreq);
    return ret;
  }
  ...
  public virtual ADLX_RESULT GetGPUMaxFrequency(out int maxFreq) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualGraphicsTuning2_GetGPUMaxFrequency(swigCPtr, out maxFreq);
    return ret;
  }
  ...
  public virtual ADLX_RESULT GetGPUVoltage(out int volt) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualGraphicsTuning2_GetGPUVoltage(swigCPtr, out volt);
    return ret;
  }
