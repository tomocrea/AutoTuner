...
public class IADLXSystemMetrics : IADLXInterface {
  ...
  public virtual ADLX_RESULT CPUUsage(out double data) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXSystemMetrics_CPUUsage(swigCPtr, out data);
    return ret;
  }

  public virtual ADLX_RESULT SystemRAM(out int data) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXSystemMetrics_SystemRAM(swigCPtr, out data);
    return ret;
  }

  public virtual ADLX_RESULT SmartShift(out int data) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXSystemMetrics_SmartShift(swigCPtr, out data);
    return ret;
  }
