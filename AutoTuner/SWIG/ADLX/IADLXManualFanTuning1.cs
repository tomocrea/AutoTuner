...
public class IADLXManualFanTuning1 : IADLXManualFanTuning {
  ...
  public virtual ADLX_RESULT GetMinAcousticLimitDefault(out int defaultVal) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualFanTuning1_GetMinAcousticLimitDefault(swigCPtr, out defaultVal);
    return ret;
  }

  public virtual ADLX_RESULT GetMinFanSpeedDefault(out int defaultVal) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualFanTuning1_GetMinFanSpeedDefault(swigCPtr, out defaultVal);
    return ret;
  }

  public virtual ADLX_RESULT GetTargetFanSpeedDefault(out int defaultVal) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualFanTuning1_GetTargetFanSpeedDefault(swigCPtr, out defaultVal);
    return ret;
  }

  public virtual ADLX_RESULT GetDefaultZeroRPMState(out bool defaultVal) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualFanTuning1_GetDefaultZeroRPMState(swigCPtr, out defaultVal);
    return ret;
  }
