...
public class IADLXManualGraphicsTuning2_1 : IADLXManualGraphicsTuning2 {
  ...
  public virtual ADLX_RESULT GetGPUMinFrequencyDefault(out int defaultVal) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualGraphicsTuning2_1_GetGPUMinFrequencyDefault(swigCPtr, out defaultVal);
    return ret;
  }

  public virtual ADLX_RESULT GetGPUMaxFrequencyDefault(out int defaultVal) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualGraphicsTuning2_1_GetGPUMaxFrequencyDefault(swigCPtr, out defaultVal);
    return ret;
  }

  public virtual ADLX_RESULT GetGPUVoltageDefault(out int defaultVal) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualGraphicsTuning2_1_GetGPUVoltageDefault(swigCPtr, out defaultVal);
    return ret;
  }
