...
public class IADLXGPUTuningServices : IADLXInterface {
  ...
  public virtual ADLX_RESULT IsAtFactory(IADLXGPU pGPU, out bool isFactory) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXGPUTuningServices_IsAtFactory(swigCPtr, IADLXGPU.getCPtr(pGPU), out isFactory);
    return ret;
  }
  ...
  public virtual ADLX_RESULT IsSupportedAutoTuning(IADLXGPU pGPU, out bool supported) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXGPUTuningServices_IsSupportedAutoTuning(swigCPtr, IADLXGPU.getCPtr(pGPU), out supported);
    return ret;
  }

  public virtual ADLX_RESULT IsSupportedPresetTuning(IADLXGPU pGPU, out bool supported) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXGPUTuningServices_IsSupportedPresetTuning(swigCPtr, IADLXGPU.getCPtr(pGPU), out supported);
    return ret;
  }

  public virtual ADLX_RESULT IsSupportedManualGFXTuning(IADLXGPU pGPU, out bool supported) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXGPUTuningServices_IsSupportedManualGFXTuning(swigCPtr, IADLXGPU.getCPtr(pGPU), out supported);
    return ret;
  }

  public virtual ADLX_RESULT IsSupportedManualVRAMTuning(IADLXGPU pGPU, out bool supported) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXGPUTuningServices_IsSupportedManualVRAMTuning(swigCPtr, IADLXGPU.getCPtr(pGPU), out supported);
    return ret;
  }

  public virtual ADLX_RESULT IsSupportedManualFanTuning(IADLXGPU pGPU, out bool supported) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXGPUTuningServices_IsSupportedManualFanTuning(swigCPtr, IADLXGPU.getCPtr(pGPU), out supported);
    return ret;
  }

  public virtual ADLX_RESULT IsSupportedManualPowerTuning(IADLXGPU pGPU, out bool supported) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXGPUTuningServices_IsSupportedManualPowerTuning(swigCPtr, IADLXGPU.getCPtr(pGPU), out supported);
    return ret;
  }
