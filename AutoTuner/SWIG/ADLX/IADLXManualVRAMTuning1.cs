...
public class IADLXManualVRAMTuning1 : IADLXInterface {
  ...
  public virtual ADLX_RESULT IsSupportedMemoryTiming(out bool supported) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualVRAMTuning1_IsSupportedMemoryTiming(swigCPtr, out supported);
    return ret;
  }
  ...
  public virtual ADLX_RESULT IsValidVRAMTuningStates(IADLXManualTuningStateList pVRAMStates, out int errorIndex) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXManualVRAMTuning1_IsValidVRAMTuningStates(swigCPtr, IADLXManualTuningStateList.getCPtr(pVRAMStates), out errorIndex);
    return ret;
  }
